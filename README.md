...
- **Persons**: Set `@ref` of `<persName>` etc. by selecting a person
  ...
  [`<prefixDef>`](https://www.tei-c.org/release/doc/tei-p5-doc/de/html/ref-listPrefixDef.html). Selection
  suggestions are generated by plugins and can be configured for
  editing contexts.
