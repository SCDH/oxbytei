...
<xsl:stylesheet
	...
	<xt:extensions 
		...
		<xt:location href="https://github.com/SCDH/oxbytei/releases/download/{/project/version}/{/project/artifactId}-{/project/version}-package.zip"/>
		...
		<xt:description xmlns="http://www.w3.org/1999/xhtml">
		    ...
		    Visit
		    https://github.com/SCDH/oxbytei/releases/tag/<xsl:value-of select="/project/version"/>
		    to see what's new.
